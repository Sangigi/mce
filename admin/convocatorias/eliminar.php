...
try {
    ...
    if (!empty($convocatoria['imagen'])) {
        $imagePath = '../../uploads/convocatorias/' . $convocatoria['imagen'];
    ...
    if (!empty($convocatoria['documento'])) {
        $docPath = '../../uploads/documentos/' . $convocatoria['documento'];
    ...
    header("Location: " . SITE_URL . "/admin/convocatorias/?mensaje=eliminado");
    exit;
} catch (PDOException $e) {
    // Redireccionar con mensaje de error
    header("Location: " . SITE_URL . "/admin/convocatorias/?mensaje=error&error=" . urlencode($e->getMessage()));
    exit;
}